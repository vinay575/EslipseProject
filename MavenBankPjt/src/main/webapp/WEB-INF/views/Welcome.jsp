...
<script>
	...
	function validateAndRedirect(action) {
		var selectedAccount = document
				.querySelector('input[name="selectedAccount"]:checked');
		if (!selectedAccount) {
		...
		<div class="container">
			...
			<div class="transactions mt-5">
				...
				<button type="button" class="btn btn-primary"
					onclick="validateAndRedirect('Statement')">Statement</button>
				<button type="button" class="btn btn-primary"
					onclick="validateAndRedirect('AddMoney')">Add Money</button>
				<button type="button" class="btn btn-primary"
					onclick="validateAndRedirect('SendMoney')">Send Money</button>
			</div>
